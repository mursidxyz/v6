                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            let wel = API(`https://api.lolhuman.xyz/api/welcomeimage?apikey=sgwn&img=${pp}&text=${name}`)
                            let lea = API(`https://api.lolhuman.xyz/api/welcomeimage?apikey=sgwn&img=${pp}&text=${name}`)
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        unreg: 'Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik :\n\n*#daftar nama.umur*\n\nContoh : *#daftar mursid ganteng.16*',
